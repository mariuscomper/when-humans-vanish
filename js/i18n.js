...
(function () {
  ...
  const RO = {
    ...
    "hero.lede": "Mâine dimineață nu se mai trezește nimeni. Fără război, fără molimă, fără asteroid. Opt miliarde de oameni pur și simplu nu mai sunt, cu trupuri cu tot, iar tot ce am construit rămâne exact acolo unde se află. Derulează ca să vezi cum observă planeta.",
    ...
    "animals.gone": "Dispar",
    "bodies.q": "Și dacă ar rămâne trupurile?",
    "bodies.p0": "În experimentul nostru dispărem cu totul. Dar dacă ne-am lăsa trupurile în urmă, ele ar cântări în jur de 390 de milioane de tone, cam de douăzeci de ori cât toate mamiferele sălbatice de pe uscat la un loc.<sup class=\"ref\"><a href=\"#src-6\" aria-label=\"Sursa 6\">6</a></sup>",
    "bodies.p1": "Muștele ar ajunge primele, în câteva minute. Apoi șobolanii, corbii, vulpile și câinii flămânzi. Afară, în căldura verii, un trup poate ajunge la oase în câteva săptămâni; în apartamentele închise și uscate, multe s-ar mumifica.",
    "bodies.p2": "Unde se descompune un trup, solul primește dintr-odată un val de azot și fosfor. Plantele de dedesubt mor, apoi cele din jur cresc mai verzi decât orice din apropiere, ani la rând.<sup class=\"ref\"><a href=\"#src-7\" aria-label=\"Sursa 7\">7</a></sup> O vreme, fiecare oraș ar fi îngrășat de propriii locuitori.",
    ...
    "sky.s1": "+ săptămâni",
    "sky.p1": "Și se întoarce noaptea. Astăzi, peste o treime din omenire nu poate vedea Calea Lactee de acasă.<sup class=\"ref\"><a href=\"#src-11\" aria-label=\"Sursa 11\">11</a></sup> Acum ea răsare din nou deasupra fiecărui oraș de pe Pământ, pentru nimeni. Trage de cursor ca să compari.",
    "sky.p2": "Aici vine o ironie crudă. Ceața aceea ne umbrea, trimițând lumina soarelui înapoi în spațiu. Fără ea, planeta se mai încălzește cu câteva zecimi de grad în aproximativ un deceniu,<sup class=\"ref\"><a href=\"#src-12\" aria-label=\"Sursa 12\">12</a></sup> o factură ascunsă care devine scadentă când nu mai e nimeni s-o plătească.",
    ...
    "co2.p0": "În ziua în care dispărem, aerul conține aproximativ 428 de părți per milion de dioxid de carbon, estimarea globală NOAA pentru septembrie 2026,<sup class=\"ref\"><a href=\"#src-15\" aria-label=\"Sursa 15\">15</a></sup> față de 280 înainte de epoca industrială. Coșurile de fum se răcesc, dar carbonul e deja acolo sus.",
    ...
    "co2.p2": "După ce oceanele s-au săturat, între o cincime și o treime din carbonul nostru e încă în aer,<sup class=\"ref\"><a href=\"#src-16\" aria-label=\"Sursa 16\">16</a></sup> iar planeta rămâne mai caldă decât în 1850. Calotele glaciare continuă să se topească secole la rând, iar mările continuă să crească mii de ani.",
    ...
    "ice.p2": "Fără noi, perioada caldă de acum ar fi durat probabil oricum încă vreo 50.000 de ani. Carbonul nostru o prelungește: într-un model, 1.000 până la 1.500 de miliarde de tone de carbon emis amână următoarea glaciațiune cu cel puțin 100.000 de ani.<sup class=\"ref\"><a href=\"#src-17\" aria-label=\"Sursa 17\">17</a></sup> În ziua în care am dispărut, eliberaserăm în jur de 740.<sup class=\"ref\"><a href=\"#src-18\" aria-label=\"Sursa 18\">18</a></sup> Dar gheața are răbdare. Dacă va crește ca ultima dată, va rade Chicago, Toronto, Stockholm și Berlin, prefăcându-le în pietriș. Bucureștiul, departe în sud, scapă.",
    "ice.p3": "Administrația parcului estimează că granitul de pe Muntele Rushmore se erodează cu aproximativ 2,5 cm la fiecare zece mii de ani.<sup class=\"ref\"><a href=\"#src-19\" aria-label=\"Sursa 19\">19</a></sup> În ritmul acesta, fețele s-ar recunoaște și după un milion de ani, dacă înghețul nu intră mai devreme în fisurile pe care nu le mai sigilează nimeni. Majoritatea speciilor de azi probabil încă există. Pe insule apar specii noi.",
    ...
    "strata.p0": "Materia primă a acelei roci e deja aici. Pe la 2020, betonul, asfaltul, cărămida, metalul, sticla și plasticul pe care le produseserăm ajunseseră la aproximativ 1.100 de miliarde de tone, adică, după o socoteală atentă, mai mult decât toată viața de pe Pământ.<sup class=\"ref\"><a href=\"#src-20\" aria-label=\"Sursa 20\">20</a></sup> Și adăugam cam 30 de miliarde de tone în fiecare an.",
    "strata.p1": "Îngropate și presate, devin rocă. Betonul ar arăta ca un conglomerat ciudat. Aluminiul, pe care natura aproape niciodată nu-l produce pur, ar putea supraviețui ca niște fulgi strălucitori. Unele materiale plastice s-ar putea turti în pelicule subțiri de carbon, așa cum se întâmplă cu frunzele fosile.<sup class=\"ref\"><a href=\"#src-21\" aria-label=\"Sursa 21\">21</a></sup>",
    "strata.p2": "Un geolog din viitorul îndepărtat ar putea găsi o bandă groasă de doar câțiva centimetri în câmp deschis și de câțiva metri sub vechile orașe și gropi de gunoi. Ar conține minerale ciudate, carbon cu o amprentă izotopică inconfundabilă și oase, un număr uriaș de oase de pui.<sup class=\"ref\"><a href=\"#src-22\" aria-label=\"Sursa 22\">22</a></sup> Treci cu mouse-ul sau atinge roca pentru a citi straturile.",
    "strata.p3": "Viața își va fi refăcut de mult varietatea. După marile extincții din trecut, inclusiv cea a asteroidului, asta a durat în jur de zece milioane de ani.<sup class=\"ref\"><a href=\"#src-23\" aria-label=\"Sursa 23\">23</a></sup> Creaturile acelei lumi vor călca peste linie fără să știe ce înseamnă.",
    "voy.s0": "Deja pe drum",
    "voy.h": "Ultimul mesaj",
    ...
    "voy.p1": "Creatorii lui se așteptau ca discul să reziste mai mult de un miliard de ani.<sup class=\"ref\"><a href=\"#src-24\" aria-label=\"Sursa 24\">24</a></sup> Cam atunci, Soarele, tot mai strălucitor, ar trebui să înceapă să fiarbă oceanele Pământului. Discul va pluti în continuare printre stele, cântând pentru nimeni, o scrisoare fără adresa expeditorului.",
